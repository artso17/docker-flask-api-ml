...
from modules.insurance_pre import InsurancePre as InPre
warnings.filterwarnings('ignore')


class InsuranceModel():
    def runModel(data, typed='multi'):
        path = pathPackages = os.environ.get('PACKAGES_MODULE',f"{os.getcwd()}/modules/packages/")
        ...
        X = data[col_p]
        colEncoder, colpOneHotEncoder, colStandarScaler = InPre.colPreparation()
